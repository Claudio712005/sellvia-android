...
import br.com.claus.sellvia.features.category.presentation.components.CategoryForm
import br.com.claus.sellvia.features.category.presentation.components.CategoryItem
...
fun ListCategoryScreen(
    ...
    val emptyPagination = Pagination<Category>(emptyList(), 0, 0, 0, 10)
